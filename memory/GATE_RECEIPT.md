...
- **Waktu:** 2026-09-05 14:36:14
- **Mode:** `quick`  ·  **Durasi total:** 51s  ·  **Pekerja statik:** 1
...
| guard:escape_layers (INV-UI-10, Esc menutup lapisan teratas saja) | FAIL (0s) |
...
| guard:atomic_claim (INV-ATOMIC-01, saga/CAS endpoint multi-koleksi) | PASS (1s) |
